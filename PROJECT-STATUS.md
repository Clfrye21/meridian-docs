...
| Landing local path | C:\Users\chris\OneDrive\Desktop\meridian-landing\index.html |
...
## 💰 FUNDRAISING STRATEGY (LOCKED)
- **Round 1:** $120K via Wefunder (Reg CF, Post-Money SAFE, $4M cap) — LIVE
- **Between rounds:** Use raise funds for $4K CPA business finance review
- **Round 2:** Second Wefunder campaign for remaining raise target
- **OpenVC role:** Investor discovery only — drives leads to Wefunder or direct SAFE

---

## 📚 FETCH FROM GITHUB WHEN NEEDED
Repo: `github.com/Clfrye21/meridian-docs`
...
## ⚡ NEVER ASK ABOUT
- GitHub repo status (documented above)
- Vercel plan (landing live, app planned)
- Product count (it's 5)
- Wefunder status (live and complete)
